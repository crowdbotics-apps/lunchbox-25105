"""lunchbox_25105 URL Configuration
...
admin.site.site_header = "Lunchbox"
admin.site.site_title = "Lunchbox Admin Portal"
admin.site.index_title = "Lunchbox Admin"

# swagger
api_info = openapi.Info(
    title="Lunchbox API",
    default_version="v1",
    description="API documentation for Lunchbox App",
)
